  ...
  return (
    ...
    variants={variants}>
        <motion.div aria-hidden="true" variants={parentAnimation} initial="hidden" animate="show" exit="exit" className="  p-2 sm:p-6 md:p-8 absolute flex flex-col gap-2 sm:gap-4 md:gap-6 lg:gap-8 xl:w-[25rem] md:w-[20rem] sm:w-[15rem] w-[8rem] 2xl:text-7xl lg:text-6xl md:text-5xl sm:text-4xl text-xl">
            ...
            <Magnetic><div className="overflow-hidden"><motion.h1 variants={firstnameAnimation}   className="title " >A</motion.h1></div></Magnetic>
            <Magnetic><div className="overflow-hidden"><motion.h1 variants={firstnameAnimation}   className="title " >L</motion.h1></div></Magnetic>
            <Magnetic><div className="overflow-hidden"><motion.h1 variants={firstnameAnimation}   className="title " >E</motion.h1></div></Magnetic>
            </div>
            <div className="text-center w-full" >
                <Magnetic><div className="overflow-hidden inline-block"> <motion.h1 variants={firstnameAnimation}   className="title " >X</motion.h1></div></Magnetic>
            </div>
        </motion.div>
        ...
        <motion.div variants={simpleAnimation} initial="hidden" animate="show" className="absolute left-0  bottom-0 p-2 sm:p-6 md:p-8  w-fit ">
            <p className="md:text-sm lg:text-base text-sm mb-6">Passionate developer proficient <br/> in <span className="text-teal-500">Django</span>, <span className="text-cyan-500">React.js</span>, <span className="text-[var(--fg-strong)]">Next.js</span>, and <span className="text-[var(--fg-strong)]">Three.js</span>.</p>
        ...
        {/* Extra bottom padding on mobile lifts the name clear of the fixed
            command-palette ("menu") chip in the bottom-right corner. */}
        <motion.div aria-hidden="true" variants={parentAnimation} initial="hidden" animate="show" className=" p-2 pb-16 sm:p-6 md:p-8 absolute right-0 bottom-0  flex flex-col gap-2 sm:gap-4 md:gap-6 lg:gap-8 2xl:text-7xl lg:text-6xl md:text-5xl sm:text-4xl text-xl">
            <Magnetic>
